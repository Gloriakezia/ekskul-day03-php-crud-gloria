        ...
        <div class="col-lg-9">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php 
                        if(isset($_GET['action']) && $_GET['action'] == 'prosess'){
                            $judul = $_POST['judul'];
                            ...
                            if($conn->query($sql) === TRUE){
                               // echo "Sukses!";
                                header ('location: ekskul&page=read');
                            } else{
                                echo"Gagal!";
                            }
                        }
                    ...
                    <form action="?menu=ekskul&page=create&action=prosess" method="post">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                ...
                                <input type="text" name="keterangan" class="form-control form-control-lg" placeholder="Tulis alamat keterangan...">
                                </span>
                            </li>
